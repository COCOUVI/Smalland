...
return [
    ...
    'password'               => [
        'letters'       => 'Le champ mot de passe doit contenir au moins une lettre.',
        'mixed'         => 'Le champ mot de passe doit contenir au moins une majuscule et une minuscule.',
        'numbers'       => 'Le champ mot de passe doit contenir au moins un chiffre.',
        'symbols'       => 'Le champ mot de passe doit contenir au moins un symbole.',
        'uncompromised' => 'La valeur du champ mot de passe est apparue dans une fuite de données. Veuillez choisir une valeur différente.',
    ],
    ...
    'custom' => [
        'password_confirmation' => [
            'same' => 'les champs password et confirmation de mot de passe doivent etre identiques',
        ],
    ],
