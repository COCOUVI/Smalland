<nav class="navbar navbar-expand-lg navbar-dark bg-primary sticky-top shadow-sm">
    <div class="container">
        ...
        <img src="{{ asset('images/smalland-1.png') }}" class="img-fluid" style="height: 60px; width: auto;" alt="Logo smalland">
            ...
            <ul class="navbar-nav me-auto">
                ...
                <li class="nav-item dropdown">
                    <a class="nav-link dropdown-toggle {{ request()->is('blog*') ? 'active' : '' }}" href="#"
                        id="blogDropdown" role="button" data-bs-toggle="dropdown">
                        Blog Agronomie
                    </a>
                    <ul class="dropdown-menu">
                        <li><a class="dropdown-item {{ request()->is('blog-list') ? 'active' : '' }}"
                                href="{{ route('blog.list') }}">Tous les articles</a></li>
                        <li><a class="dropdown-item {{ request()->is('blog-category') ? 'active' : '' }}"
                                href="{{ route('blog.category') }}">Catégories</a></li>
                    </ul>
                </li>

                {{-- Formations --}}
                <li class="nav-item dropdown">
                    <a class="nav-link dropdown-toggle {{ request()->is('formations*') ? 'active' : '' }}"
                        href="#" id="formationsDropdown" role="button" data-bs-toggle="dropdown">
                        Formations
                    </a>
                    <ul class="dropdown-menu">
                ...
                {{-- Boutique --}}
                <li class="nav-item dropdown">
                    <a class="nav-link dropdown-toggle {{ request()->is('boutique*') ? 'active' : '' }}" href="#"
                        id="shopDropdown" role="button" data-bs-toggle="dropdown">
                        Boutique
                    </a>
                    <ul class="dropdown-menu">
                        <li><a class="dropdown-item {{ request()->is('products-list') ? 'active' : '' }}"
                    ...
                    <div class="dropdown">
                        ...
                        <ul class="dropdown-menu dropdown-menu-end">
                            ...
                            @if (auth()->user()->role === 'client')
                                <li><a class="dropdown-item" href="{{ route('espace.etudiant') }}">Mon espace étudiant</a>
                                </li>
                                <li><a class="dropdown-item" href="">Mon espace client</a></li>
                                <li><a class="dropdown-item" href="#">Mon profil</a></li>
                                <li><a class="dropdown-item" href="#">Paramètres</a></li>
                            @else
                                <li><a class="dropdown-item" href="{{ route('dashboard') }}">Mon espace Administrateur</a>
                                </li>
                            @endif
                            <li>
