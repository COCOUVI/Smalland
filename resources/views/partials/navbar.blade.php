        ...
        <div class="collapse navbar-collapse" id="navbarNav">
            <ul class="navbar-nav me-auto">
                ...
                <li class="nav-item dropdown">
                    ...
                    <ul class="dropdown-menu">
                        <li><a class="dropdown-item {{ request()->is('') ? 'active' : '' }}" href="">Catalogue</a></li>
                        @auth
                            <li><a class="dropdown-item {{ request()->is('student-dashboard') ? 'active' : '' }}" href="{{ route('espace.etudiant') }}">Espace étudiant</a></li>
                        @endauth
                    </ul>
                </li>
            ...
            <div class="d-flex align-items-center">
                ...
                <div class="dropdown">
                    ...
                    <ul class="dropdown-menu dropdown-menu-end">
                        <li><a class="dropdown-item" href="{{ route('espace.etudiant') }}">Mon espace</a></li>
