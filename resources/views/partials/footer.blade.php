        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col-md-6 mb-3">
                    <p class="mb-0">&copy; 2025 Small Land. Tous droits réservés.</p>
                </div>
                <div class="col-md-6 mb-3 text-md-end">
                    <p class="mb-0">Made with <i class="bi bi-heart-fill text-danger"></i> for agriculture and breeding enthusiasts</p>
                </div>
            </div>
        </div>
    </footer>
