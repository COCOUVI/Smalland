        ...
        <div class="container">
            <div class="row align-items-center">
                ...
                mb-3">
                    ...
                    <p class="lead mb-4">Apprenez à maximiser votre production sur de petites surfaces avec des techniques
                        écologiques.</p>
                    ...
                    <div class="card pricing-card">
                        <div class="card-body text-center">
                            ...
                            <ul class="list-unstyled text-start">
                                ...
                                <li class="mb-2"><i class="bi bi-check-circle text-success me-2"></i> 5 ressources
                                    téléchargeables</li>
                        ...
                        <div class="row">
                            <div class="col-md-3 text-center">
                                <img src="https://images.unsplash.com/photo-1560250097-0b93528c311a?ixlib=rb-4.0.3&auto=format&fit=crop&w=400&q=80"
                                    alt="Formateur" class="instructor-img">
                            </div>
                            <div class="col-md-9">
                                <h4>Jean Martin</h4>
                                ...
                                <p>Agriculteur bio depuis 15 ans, Jean Martin a transformé sa ferme familiale en modèle de
                                    maraîchage bio intensif. Diplômé en agronomie, il partage maintenant son expertise à
                                    travers des formations et des consultations.</p>
                    ...
                    <div class="card-body">
                        ...
                        <div class="border-bottom pb-3 mb-3">
                            <div class="d-flex align-items-center mb-2">
                                <img src="https://images.unsplash.com/photo-1544005313-94ddf0286df2?ixlib=rb-4.0.3&auto=format&fit=crop&w=50&q=80"
                            ...
                            <p>J'ai beaucoup apprécié cette formation qui m'a donné toutes les clés pour démarrer mon projet
                                de maraîchage. Les exercices pratiques sont particulièrement utiles.</p>
                        ...
                        <div class="border-bottom pb-3 mb-3">
                            ...
                            <p>Le formateur est très compétent et sait transmettre son savoir. J'ai particulièrement
                                apprécié les études de cas concrets.</p>
                        ...
                        <div class="accordion" id="faqAccordion">
                            <div class="accordion-item">
                                ...
                                <div id="faq1" class="accordion-collapse collapse show"
                                    ...
                                    <div class="accordion-body">
                                        Vous avez un accès à vie à cette formation. Après votre inscription, vous pouvez y
                                        accéder à tout moment, sur tous vos appareils.
                                    </div>
                                </div>
                            </div>
                            <div class="accordion-item">
                                ...
                                <div id="faq2" class="accordion-collapse collapse" data-bs-parent="#faqAccordion">
                                    <div class="accordion-body">
                                        Nous offrons une garantie satisfait ou remboursé de 30 jours. Si vous n'êtes pas
                                        satisfait de la formation, contactez-nous dans les 30 jours suivant votre achat pour
                            ...
                            <div class="accordion-item">
                                ...
                                <div id="faq3" class="accordion-collapse collapse" data-bs-parent="#faqAccordion">
                                    <div class="accordion-body">
                                        Non, aucun matériel particulier n'est nécessaire pour suivre la formation.
                                        Cependant, si vous souhaitez mettre en pratique les techniques enseignées, vous
                                        aurez besoin d'un accès à un terrain, même de petite taille.
                                    </div>
                                </div>
                            </div>
                        </div>
                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="d-flex mb-3">
                            <img src="https://images.unsplash.com/photo-1416879595882-3373a0480b5b?ixlib=rb-4.0.3&auto=format&fit=crop&w=100&q=80"
                                class="flex-shrink-0 me-3" width="80" alt="Formation">
                            <div>
                        ...
                        <div class="d-flex">
                            <img src="https://images.unsplash.com/photo-1593686340314-42f27a1e50c9?ixlib=rb-4.0.3&auto=format&fit=crop&w=100&q=80"
                                class="flex-shrink-0 me-3" width="80" alt="Formation">
                            <div>
