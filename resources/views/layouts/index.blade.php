    ...
    <div>
        ...
        <section class="hero-section text-center">
            <div class="container">
                ...
                <p class="lead mb-4">La première plateforme béninoise dédiée à l’innovation, à la formation et à la
                    fourniture d’équipements et intrants dans les domaines de l’élevage et de l’agriculture.</p>
            ...
            <div class="container">
                <div class="row align-items-center">
                    ...
                    <div class="col-md-6">
                        ...
                        <p>Small Land est une petite ferme familiale créée en 2010 par la famille Dupont. Installés en
                            pleine campagne, nous avons développé avec passion une ferme pédagogique où nous élevons des
                            lapins et des poules en liberté.</p>
                        <p>Toute la famille participe aux activités : les enfants adorent nourrir les lapins et ramasser les
                            œufs frais chaque matin. Nous avons également développé un incubateur artisanal pour faire
                            naître nos poussins.</p>
                        <p>Notre philosophie : une agriculture respectueuse des animaux et de l'environnement, dans la joie
                            et la simplicité.</p>
                ...
                <div class="container">
                    <div class="row text-center">
                        <div class="col-md-4 mb-4">
                            ...
                            <p>Des articles experts sur les techniques agricoles modernes, l'écologie et le développement
                                durable.</p>
                        ...
                        <div class="col-md-4 mb-4">
                            ...
                            <h3>Formations</h3>
                            <p>Des cours en ligne complets avec vidéos, ressources et certifications pour développer vos
                                compétences.</p>
                        ...
                        <div class="col-md-4 mb-4">
                            ...
                            <h3>Boutique</h3>
                            <p>Des outils, équipements et produits sélectionnés pour vos projets agricoles et votre jardin.
                            </p>
                ...
                <div class="row">
                    ...
                    <div class="col-md-4 mb-4">
                        <div class="card h-100">
                            ...
                            <img src="https://images.unsplash.com/photo-1597848212624-e9d2c1e7a50d?ixlib=rb-4.0.3&auto=format&fit=crop&w=500&q=80"
                                class="card-img-top" alt="Permaculture">
                            <div class="card-body">
                                <h5 class="card-title">Introduction à la permaculture</h5>
                                <p class="card-text">Découvrez les principes de base de la permaculture et comment les
                                    appliquer dans votre jardin.</p>
                    ...
                    <div class="col-md-4 mb-4">
                        <div class="card h-100">
                            ...
                            <img src="https://images.unsplash.com/photo-1625246335525-8b5e7e723b64?ixlib=rb-4.0.3&auto=format&fit=crop&w=500&q=80"
                                class="card-img-top" alt="Agriculture Bio">
                            <div class="card-body">
                                <h5 class="card-title">Les bienfaits de l'agriculture biologique</h5>
                                <p class="card-text">Pourquoi et comment passer à une agriculture respectueuse de
                                    l'environnement.</p>
                                <div class="d-flex justify-content-between align-items-center">
                    ...
                    <div class="col-md-4 mb-4">
                        <div class="card h-100">
                            ...
                            <img src="https://images.unsplash.com/photo-1590172205845-2441aae4bad4?ixlib=rb-4.0.3&auto=format&fit=crop&w=500&q=80"
                                class="card-img-top" alt="Techniques agricoles">
                            <div class="card-body">
                                <h5 class="card-title">Nouvelles techniques d'irrigation</h5>
                                <p class="card-text">Optimisez votre consommation d'eau avec ces méthodes d'irrigation
                                    modernes et efficaces.</p>
                                <div class="d-flex justify-content-between align-items-center">
        ...
        <section class="py-5 bg-light">
            <div class="container">
                ...
                <div class="row">
                    ...
                    <div class="col-md-3 col-sm-6 mb-4">
                        <div class="card h-100">
                            <img src="https://images.unsplash.com/photo-1595341888016-a392ef81b7de?ixlib=rb-4.0.3&auto=format&fit=crop&w=500&q=80"
                                class="card-img-top" alt="Kit jardinage">
                            <div class="card-body">
                    ...
                    <div class="col-md-3 col-sm-6 mb-4">
                        <div class="card h-100">
                            <img src="https://images.unsplash.com/photo-1589923188937-cb64779f4abe?ixlib=rb-4.0.3&auto=format&fit=crop&w=500&q=80"
                                class="card-img-top" alt="Serre">
                            <div class="card-body">
                    ...
                    <div class="col-md-3 col-sm-6 mb-4">
                        <div class="card h-100">
                            <img src="https://images.unsplash.com/photo-1471194402529-8e0f5a675de6?ixlib=rb-4.0.3&auto=format&fit=crop&w=500&q=80"
                                class="card-img-top" alt="Graines bio">
                            <div class="card-body">
                    ...
                    <div class="col-md-3 col-sm-6 mb-4">
                        <div class="card h-100">
                            <img src="https://images.unsplash.com/photo-1596461404969-9b70b3e2a60d?ixlib=rb-4.0.3&auto=format&fit=crop&w=500&q=80"
                                class="card-img-top" alt="Arrosoir">
                            <div class="card-body">
        ...
        <section class="py-5">
            <div class="container">
                ...
                <div class="row g-3 mt-4">
                    <div class="col-md-4">
                        <img src="http://static.photos/agriculture/320x240/1" class="img-fluid rounded shadow"
                            alt="Enfants nourrissant les lapins">
                    </div>
                    <div class="col-md-4">
                        <img src="http://static.photos/agriculture/320x240/2" class="img-fluid rounded shadow"
                            alt="Poulailler">
                    </div>
                    <div class="col-md-4">
                        <img src="http://static.photos/agriculture/320x240/3" class="img-fluid rounded shadow"
                            alt="Incubateur artisanal">
                    </div>
                </div>
                <div class="text-center mt-4">
            ...
            <div class="container">
                <div class="row justify-content-center">
                    <div class="col-md-8 text-center">
                        ...
                        <p class="mb-4">Inscrivez-vous à notre newsletter pour recevoir les derniers articles, nouvelles
                            formations et offres spéciales.</p>
