                        ...
                        <div class="card-body">
                            ...
                            @foreach ($cart->items as $item)
                                <div class="d-flex align-items-center mb-3 pb-3 border-bottom">
                                    ...
                                    <strong>{{ number_format($item->product->prix * $item->qte, 0, ',', ' ') }}
                                        FCFA</strong>
                                </div>
                            @endforeach
                        </div>
                ...
                <div class="col-lg-4">
                    <div class="card sticky-top" style="top: 20px;">
                        <div class="card-body">
                            ...
                            <button type="button" id="btn-pay" class="btn btn-primary btn-lg w-100 mt-4">
    ...
    <script>
        ...
        document.addEventListener('DOMContentLoaded', () => {
            ...
            const widget = FedaPay.init({
                ...
                transaction: {
                    amount: {{ $total }}, // ou total dynamique côté serveur
                ...
                onComplete: function(data) {
                    ...
                    if (data.reason === 'CHECKOUT COMPLETE') {
                        console.log('Paiement validé, envoi vers Laravel...');

                        const form = document.createElement('form');
                        form.method = 'POST';
                        form.action = '{{ route('checkout.process') }}'; // route Laravel à créer
                        ...
                        ['address', 'telephone', 'mode_livraison'].forEach(name => {
                            const field = originalForm.querySelector(`[name="${name}"]`);
                            if (field) {
                        ...
                        alert('Paiement annulé ou non complété.');
                    }
                }
            });

            // 🔘 Bouton pour ouvrir la fenêtre de paiement
