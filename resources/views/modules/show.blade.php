        ...
        function openLessonModal(lesson) {
            ...
            <div class="mb-6">
                ...
                <div class="aspect-w-16 aspect-h-9">
                    <iframe src="/storage/${lesson.video_url}" class="w-full h-64 md:h-96 rounded-lg" frameborder="0" allowfullscreen></iframe>
                </div>
            </div>
        `;
            }
            ...
            <div>
                ...
                <a href="/storage/${lesson.pdf_url}" target="_blank" class="inline-flex items-center text-very-green hover:text-green-600">
