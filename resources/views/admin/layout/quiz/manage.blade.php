                    ...
                    <form method="POST" action="{{ route('quizz.storeOrUpdate', $module->id) }}">
                        ...
                        <div id="reponses-container">
                            <div class="mb-3 d-flex align-items-center">
                                <input type="text" name="reponses[]" class="form-control me-3" placeholder="Réponse 1" required>
                                <div class="form-check">
                                    <input type="radio" name="is_correct" value="0" class="form-check-input" id="new_correct_0" required>
                                    <label class="form-check-label" for="new_correct_0">Correct</label>
                                </div>
                            </div>
                            <div class="mb-3 d-flex align-items-center">
                                <input type="text" name="reponses[]" class="form-control me-3" placeholder="Réponse 2" required>
                                <div class="form-check">
                                    <input type="radio" name="is_correct" value="1" class="form-check-input" id="new_correct_1" required>
                                    <label class="form-check-label" for="new_correct_1">Correct</label>
                                </div>
                            </div>
                        </div>
                                            ...
                                            @foreach ($question->reponses as $rIndex => $rep)
                                                <div class="mb-3 d-flex align-items-center reponse-item">
                                                    <input type="text" name="reponses[{{ $rep->id }}]"
                                                        class="form-control me-3" value="{{ $rep->content }}" required>

                                                    <div class="form-check me-3">
                                                        <input type="radio" name="correct_reponse" value="{{ $rep->id }}"
                                                               class="form-check-input" id="edit_correct_{{ $rep->id }}"
                                                               {{ $rep->is_correct ? 'checked' : '' }} required>
                                                        <label class="form-check-label" for="edit_correct_{{ $rep->id }}">
                                                            Correct
                                                        </label>
                                                    </div>
