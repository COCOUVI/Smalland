<aside id="sidebar-wrapper">
    <div class="sidebar-brand">
         <img src="{{asset('images/smalland.jpeg')}}" alt=""  style="width: 150px; height: auto;">
    </div>

    <ul class="sidebar-menu ">
        <li class="menu-header fw-bold fs-4" style="padding-top: 20px;">Tableau de bord</li>
...
<style>
    ...
    width: 150px;
    height: auto;
    margin-bottom: 20px; /* espace entre image et menu */
}

.sidebar-menu .menu-header {
    padding-top: 15px; /* espace supplémentaire au début des sections */
}
